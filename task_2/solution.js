...
function calcDiscount(sum, min, discount) {
    ...
    if (productSum >= discountMinSum) { // если productSum больше или равно discountMinSum,
        console.log(discountPrice = (discountPart * productSum)/100); // то присвойте discountPrice значение discountPart процентов от productsSum,
    } else { 
        console.log(discountPrice = 0); // иначе присвойте discountPrice значения 0
    }
